uploadIos() {
  read -p "Please enter path of file to upload to Sauce Labs [${WALMART_APP_FILENAME_IOS:-./mx/app/glass.zip}]: " UPLOAD_APP_PATH &&
  UPLOAD_APP_PATH=${UPLOAD_APP_PATH:-${WALMART_APP_FILENAME_IOS:-'./mx/app/glass.zip'}} &&
...
uploadAndroid() {
  read -p "Please enter path of file to upload to Sauce Labs [${WALMART_APP_FILENAME_ANDROID:-./mx/app/glass.apk}]: " UPLOAD_APP_PATH &&
  UPLOAD_APP_PATH=${UPLOAD_APP_PATH:-${WALMART_APP_FILENAME_ANDROID:-'./mx/app/glass.apk'}} &&
...
uploadCommon() {
  read -p "Please enter path of file to upload to Sauce Labs common account (ce-r2) [Example: ./mx/app/glass.zip]: " UPLOAD_APP_PATH &&
