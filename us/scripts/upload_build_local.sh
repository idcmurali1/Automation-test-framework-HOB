uploadIos() {
  read -p "Please enter path of file to upload to Sauce Labs [${WALMART_APP_FILENAME_IOS:-./us/app/glass.zip}]: " UPLOAD_APP_PATH &&
  UPLOAD_APP_PATH=${UPLOAD_APP_PATH:-${WALMART_APP_FILENAME_IOS:-'./us/app/glass.zip'}} &&
...
uploadAndroid() {
  read -p "Please enter path of file to upload to Sauce Labs [${WALMART_APP_FILENAME_ANDROID:-./us/app/glass.apk}]: " UPLOAD_APP_PATH &&
  UPLOAD_APP_PATH=${UPLOAD_APP_PATH:-${WALMART_APP_FILENAME_ANDROID:-'./us/app/glass.apk'}} &&
...
uploadCommon() {
  read -p "Please enter path of file to upload to Sauce Labs common account (ce-r2) [Example: ./us/app/glass.zip]: " UPLOAD_APP_PATH &&
